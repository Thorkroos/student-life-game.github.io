...
- 行政清单：银行账户、电话卡/交通、OSHC、住址更新、USI/学生证、TFN/Super
...
- 100 个事件文件内事件，其中恋爱线暂时隐藏，当前游玩不会触发 dating 事件
- 事件覆盖：租房、OSHC、银行卡、交通卡、census date、Turnitin、tutorial、打工、TFN/Super、course progress、学校支持服务、政策信息污染、毕业签证准备、graduate program、推荐信、退租押金、家庭沟通和自我认知
- 本地存档：localStorage
- 通关后显示结算报告和称号
...
- 恋爱线隐藏状态下，5000 局模拟未触发 dating 事件
